      ...
      <div class="card">
        ...
        <div class="flex flex-col gap-12">
          ${[
            ...
            { name: 'Global Tech', risk: 42, color: 'var(--color-text-warning)' },
            { name: 'Zenith Logistics', risk: 15, color: 'var(--color-text-success)' },
            { name: 'CloudScale Inc', risk: 38, color: 'var(--color-text-warning)' }
        ].map(e => `
            <div>
