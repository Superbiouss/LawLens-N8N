export function renderAnnotations(container) {
    ...
    <div style="display:grid;grid-template-columns:1fr 340px;height:calc(100vh - var(--topbar-height) - 44px);margin:0 -24px -24px;">
      ...
      <div style="background:var(--color-background-tertiary);overflow-y:auto;padding:40px;display:flex;justify-content:center;">
        <div class="card" style="max-width:800px;width:100%;min-height:1000px;padding:60px 80px;box-shadow:0 4px 20px rgba(0,0,0,0.05);">
          ...
          <p style="font-size:13px;font-weight:500;margin-bottom:12px;">1. DEFINITION OF CONFIDENTIAL INFORMATION</p>
      ...
      <div style="background:var(--color-background-primary);border-left:0.5px solid var(--color-border-tertiary);display:flex;flex-direction:column;">
        <div style="padding:16px;border-bottom:0.5px solid var(--color-border-tertiary);display:flex;justify-content:space-between;items-center;">
          <h3 class="section-label" style="margin:0;">Annotations (3)</h3>
        ...
        <div style="flex:1;overflow-y:auto;padding:16px;display:flex;flex-direction:column;gap:12px;">
          ...
          <div class="card" style="padding:12px;border-color:var(--color-border-danger);background:var(--color-background-info);">
            <div class="flex items-center gap-8 mb-8">
              <div class="chat-avatar user" style="width:20px;height:20px;font-size:10px;">JD</div>
              <span style="font-size:12px;font-weight:500;">John Doe</span>
              <span class="meta-text" style="font-size:10px;">10:42 AM</span>
            </div>
            <p style="font-size:12px;color:var(--color-text-primary);line-height:1.5;">This damages clause is a dealbreaker. We need to cap this at 1x the contract value or actual harm.</p>
            <div style="margin-top:10px;padding-top:10px;border-top:0.5px solid var(--color-border-tertiary);">
              <div class="flex items-center gap-8">
                <div class="chat-avatar user" style="width:20px;height:20px;font-size:10px;background:var(--color-brand-purple);color:white;">AS</div>
                <span style="font-size:12px;font-weight:500;">Anand S.</span>
                <span class="meta-text" style="font-size:10px;">Just now</span>
              </div>
              <p style="font-size:12px;color:var(--color-text-secondary);margin-top:4px;">Agreed. I'll draft the redline for this.</p>
            </div>
          </div>
          ...
          <div class="card" style="padding:12px;">
            <div class="flex items-center gap-8 mb-8">
              ...
              <span style="font-size:11px;font-weight:500;text-transform:uppercase;color:var(--color-text-warning);">Clause 2 · Highlight</span>
            </div>
            <p style="font-size:12px;color:var(--color-text-secondary);line-height:1.4;">"not disclose to any third party Confidential Information"</p>
