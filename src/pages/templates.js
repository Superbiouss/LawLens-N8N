const TEMPLATES = [
  {
    ...
    desc: 'Standard non-disclosure agreement for mutual information exchange.',
    usage: '2.4k uses',
    risk: 'low',
  },
  {
    name: 'Software Development Agreement',
    cat: 'Service Agreements',
    desc: 'Contract for outsourcing software development work.',
    usage: '1.2k uses',
    risk: 'medium',
  },
  {
    ...
    cat: 'Employment',
    desc: 'Full-time employment agreement with standard clauses.',
    usage: '5.1k uses',
    risk: 'medium',
  },
  {
    ...
    cat: 'Real Estate',
    desc: 'Lease for office or retail space in commercial properties.',
    usage: '800 uses',
    risk: 'high',
  },
  {
    ...
    cat: 'Service Agreements',
    desc: 'Framework agreement for licensing software as a service.',
    usage: '1.5k uses',
    risk: 'medium',
  },
  {
    ...
    cat: 'Corporate',
    desc: 'Governing agreement for startup co-founders.',
    usage: '600 uses',
    risk: 'high',
  },
];
  ...
  const render = () => {
    ...
    container
      ...
      ?.addEventListener('click', () => {
        window.showToast(
          'Custom template creation would open the drafting flow.',
        );
      });
    ...
    container.querySelectorAll('[data-template-name]').forEach((button) => {
      button.addEventListener('click', () => {
        localStorage.setItem(
          'drafting_insert_clause',
          `${button.dataset.templateName} template inserted as a starting point.`,
        );
